...
# Renamed from core/overseer.py to distinguish from antigravity/overseer/daemon.py (agentic overseer).
# This module: Page-Hinkley drift detection + shadow-training daemon used by live_daemon.py.
