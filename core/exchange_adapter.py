...
# Renamed from core/gateway.py to distinguish from antigravity/gateway/ (FastAPI WebSocket layer).
# This module: ccxt-based exchange adapter + risk manager used by live_daemon.py.
